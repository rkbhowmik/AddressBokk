...
namespace AddressBookApp.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder)
        {
            ...
            var peoples = from p in _context.Peoples
                select p;
            switch (sortOrder)
            {
                case "name_desc":
            ...
            return View(await peoples.AsNoTracking().ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,FirstName,LastName,PersonNumber")] People people)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,LastName,PersonNumber")] People people)
        {
